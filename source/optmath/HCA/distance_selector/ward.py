...
def _alpha(new: Cluster, other: Cluster, total_item_count: int):
    return (len(new.left) + len(other)) / (total_item_count)


def _beta(new: Cluster, other: Cluster, total_item_count: int):
    return (len(new.right) + len(other)) / (total_item_count)


def _gamma(other: Cluster, total_item_count: int):
